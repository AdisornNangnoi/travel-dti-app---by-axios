...
function Register() {
  ...
  const handleRegisterClick = async (e) => {
    ...
    if (travellerFullname.trim().length == 0) {
      ...
      try {
        // const response = await fetch("https://travel-service-server-by-prisma-iota.vercel.app//traveller/", {
        //   method: "POST",
        //   body: formData,
        // });
        const response = await axios.post(
          "https://travel-service-server-by-prisma-iota.vercel.app//traveller/",
          formData,
          {
            headers: {
      ...
      <Box sx={{ width: "60%", boxShadow: 4, mx: "auto", my: "auto", p: 5 }}>
        ...
        <Avatar
          src={
            travellerImage == null
              ? Profile
              : URL.createObjectURL(travellerImage)
          }
          alt="travel logo"
          sx={{ width: 150, height: 150, mx: "auto", my: 5 }}
        ></Avatar>
